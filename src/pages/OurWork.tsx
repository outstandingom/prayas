...
export default function OurWork() {
  ...
  // ========== CATEGORIES (data truncated for brevity – same as before) ==========
  const categories: WorkCategory[] = [
    // ... all categories as in the previous version (no change to data)
  ]
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {/* ===== BACK – with border ===== */}
                  <div
                    className="absolute inset-0 [backface-visibility:hidden] [transform:rotateY(180deg)] rounded-2xl overflow-hidden shadow-lg p-6 flex flex-col justify-between border-8"
                    style={{
