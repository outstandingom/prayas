...
interface WorkCategory {
  ...
  borderColor: string // e.g., 'border-emerald-500' (new)
  image: string
}
...
export default function OurWork() {
  ...
  return (
    <div className="min-h-screen bg-white pt-8 pb-16">
      ...
      {/* Detailed Categories – each with its own colour theme */}
      <motion.div
        variants={containerVariants}
        initial="hidden"
        animate="visible"
      ...
      >
        {categories.map((category) => {
          ...
          // Convert bgColor (e.g., 'bg-emerald-50') to a background class with opacity
          const bgClass = category.bgColor.replace('bg-', '') // e.g., 'emerald-50'
          return (
            <motion.div
              key={category.id}
            ...
            >
              {/* Category Banner Image with colour‑matched overlay */}
              ...
              {/* Category Items – now with colour‑accented "Learn More" */}
              <motion.div
                variants={containerVariants}
                initial="hidden"
                whileInView="visible"
                ...
                {category.items.map((item, idx) => (
                  ...
                  >
                    ...
                    <div className="relative z-10 h-full flex flex-col justify-end p-6 text-white">
                      ...
                      {/* Learn More button – now uses category colour */}
                      <button
                        onClick={(e) => {
                          e.stopPropagation()
