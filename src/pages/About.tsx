...
import { Link } from 'react-router-dom'// src/pages/About.tsx
import { motion } from 'framer-motion'
...
export default function About() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          >
            ...
            <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-[#263238] mb-6 leading-tight">
              ...
              <span className="text-[#FFF314]">Transforming Lives</span>
            </h1>
      ...
      {/* Stats Section */}
      <section className="py-12 bg-[#F1F8F5]/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {stats.map((stat, i) => (
              ...
              >
                <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#FFF314] mb-2">{stat.value}</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="relative bg-gradient-to-br from-[#FFF314] to-[#FFF314]/80 rounded-2xl p-8 md:p-10 text-[#263238] shadow-xl shadow-[#FFF314]/20"
            >
              <div className="w-14 h-14 rounded-2xl bg-white/30 flex items-center justify-center mb-6">
                <Target className="w-7 h-7" />
              </div>
              <h2 className="text-2xl md:text-3xl font-bold mb-4">Our Mission</h2>
              <p className="text-[#263238]/80 leading-relaxed">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="relative bg-white border border-[#FFF314]/10 rounded-2xl p-8 md:p-10 shadow-lg"
            >
              <div className="w-14 h-14 rounded-2xl bg-[#F1F8F5] flex items-center justify-center mb-6">
                <Eye className="w-7 h-7 text-[#FFF314]" />
              </div>
      ...
      {/* Core Values */}
      <section className="py-20 md:py-28 bg-[#F1F8F5]/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.4, delay: i * 0.1 }}
                className="group bg-white rounded-2xl p-6 border border-[#FFF314]/10 shadow-lg hover:shadow-xl hover:shadow-[#FFF314]/10 transition-all duration-300 hover:-translate-y-1"
              >
                <div className="w-12 h-12 rounded-xl bg-[#F1F8F5] flex items-center justify-center mb-4 group-hover:bg-[#FFF314] transition-colors duration-300">
                  <value.icon className="w-6 h-6 text-[#FFF314] group-hover:text-[#263238] transition-colors duration-300" />
                </div>
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="relative">
            {/* Vertical Line */}
            <div className="absolute left-4 md:left-1/2 top-0 bottom-0 w-px bg-[#FFF314]/20 md:-translate-x-px" />
            ...
            <div className="space-y-8 md:space-y-12">
              {milestones.map((milestone, i) => (
                ...
                >
                  {/* Dot on timeline */}
                  <div className="absolute left-4 md:left-1/2 w-3 h-3 bg-[#FFF314] rounded-full -translate-x-1/2 mt-1.5 z-10 shadow-lg shadow-[#FFF314]/30" />

                  {/* Content */}
                  <div className={`ml-10 md:ml-0 md:w-1/2 ${i % 2 === 0 ? 'md:pr-16 md:text-right' : 'md:pl-16'}`}>
                    <div className="bg-white border border-[#FFF314]/10 rounded-xl p-5 shadow-lg hover:shadow-xl transition-shadow">
                      <span className="text-[#FFF314] font-mono text-xs font-bold tracking-wider">{milestone.year}</span>
      ...
      <section className="py-20 bg-gradient-to-br from-[#FFF314] to-[#FFF314]/80">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <Quote className="w-10 h-10 text-[#263238]/30 mx-auto mb-6" />
            <blockquote className="text-xl md:text-2xl lg:text-3xl text-[#263238] font-medium leading-relaxed mb-6">
            ...
            <div className="text-[#263238]/70 font-semibold">— Founder, Prayas Samaj Sevi Sanstha</div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <div className="w-16 h-16 rounded-2xl bg-[#F1F8F5] flex items-center justify-center mx-auto mb-6">
              <Handshake className="w-8 h-8 text-[#FFF314]" />
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                to="/volunteer"
                className="px-8 py-3 bg-[#FFF314] text-[#263238] rounded-full font-semibold hover:bg-[#FFF314]/90 transition-all shadow-lg shadow-[#FFF314]/20 hover:scale-105 inline-flex items-center gap-2"
              >
                Become a Volunteer <ArrowRight className="w-4 h-4" />
              </Link>
              <Link
                to="/donate"
                className="px-8 py-3 bg-[#F1F8F5] text-[#263238] rounded-full font-semibold hover:bg-[#FFF314]/10 transition-all hover:scale-105 inline-flex items-center gap-2"
              >
                <Heart className="w-4 h-4 text-[#FFF314]" /> Donate Now
              </Link>
            </div>
          </motion.div>
        </div>
