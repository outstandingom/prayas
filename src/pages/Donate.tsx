...
export default function Donate() {
  ...
  const handleDonate = (e: React.FormEvent) => {
    ...
    // If the user returns to the page, we can show a thank you message,
    // but we don't have a way to confirm payment. We'll just reset loading after a moment.
    // Optionally, we could open the link in a new tab to keep the page open.
    // But for simplicity, we redirect.
    // If the user cancels, they will come back to this page.
    // We can set a timeout to reset loading if they return.
    setTimeout(() => {
      setLoading(false)
    }, 5000)
  }
      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          <form onSubmit={handleDonate} className="space-y-6">
            ...
            {/* Payment Method - We only support UPI for now */}
            <div>
              <label className="flex items-center gap-2 text-sm font-medium text-[#263238] mb-3">
