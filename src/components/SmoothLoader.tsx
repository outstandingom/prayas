...
export default function SmoothLoader() {
  ...
  return (
    <AnimatePresence onExitComplete={() => setPhase('done')}>
      ...
      >
        {/* Ambient Glow - Updated to Yellow */}
        <motion.div
          className="absolute rounded-full"
          style={{
            width: 'clamp(200px, 60vw, 520px)',
            height: 'clamp(200px, 60vw, 520px)',
            background: 'rgba(255,243,20,0.12)', // #FFF314 with opacity
        ...
        >
          {/* Icon Container - Matching Hero Theme */}
          <motion.div
          ...
          {/* Progress Bar - Updated to Yellow Gradient */}
          <div
          ...
          >
            ...
            <motion.div
              className="absolute inset-y-0 rounded-full blur-sm"
              style={{ 
