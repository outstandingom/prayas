  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        // Increased bottom values to move it HIGHER above the donate button
        className="fixed bottom-44 right-4 sm:bottom-32 sm:right-8 z-50 flex flex-col items-center gap-1.5"
      >
        <Link
          to="/volunteer"
