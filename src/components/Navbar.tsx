  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        isScrolled
          ? 'bg-white/80 backdrop-blur-lg shadow-[0_10px_30px_-20px_rgba(38,50,56,0.15)] py-2 sm:py-3'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              className="md:hidden text-[#263238] p-2.5 -m-1 rounded-full hover:bg-[#FFF314]/10 active:bg-[#FFF314]/20 transition-colors"
      ...
      <AnimatePresence>
        {isMobileOpen && (
          <motion.div
            ...
            className="md:hidden bg-white/90 backdrop-blur-lg border-t border-[#FFF314]/10 mt-2 overflow-hidden"
          >
              ...
              {navLinks.map((link) => (
                <Link
                  ...
                  className={`text-lg font-medium py-3 px-2 rounded-lg transition-colors ${
                    location.pathname === link.path
                      ? 'text-[#FFF314] bg-[#FFF314]/5'
                      : 'text-[#263238]/80 hover:text-[#263238] hover:bg-[#FFF314]/5'
                  }`}
                >
                  {link.name}
                </Link>
